...
class KeyAndValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:myMessage.KeyAndValue) */ {
 public:
  KeyAndValue();
  virtual ~KeyAndValue();
  ...
  inline KeyAndValue* New() const final {
    return CreateMaybeMessage<KeyAndValue>(NULL);
  }
...
class Key : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:myMessage.Key) */ {
 public:
  Key();
  virtual ~Key();
...
class Value : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:myMessage.Value) */ {
 public:
  Value();
  virtual ~Value();
...
class StorageInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:myMessage.StorageInfo) */ {
 public:
  StorageInfo();
  virtual ~StorageInfo();
  ...
  inline StorageInfo* New() const final {
    return CreateMaybeMessage<StorageInfo>(NULL);
  }
...
class Empty : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:myMessage.Empty) */ {
 public:
  Empty();
  virtual ~Empty();
